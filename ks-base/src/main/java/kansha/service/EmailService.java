...
public class EmailService {
    ...
    public void sendCode(String code, String receiveMail){
        try {
            ...
            message.setContent("【看啥网】"+code+"为您的验证码，请于30分钟内填写。如非本人操作，请忽略本短信。", "text/html;charset=UTF-8");
...
//        message.setFrom(new InternetAddress(sendMail, "看啥网", "UTF-8"));
//
